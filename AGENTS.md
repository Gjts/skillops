...
This project is indexed by GitNexus as **skillops** (3962 symbols, 10946 relationships, 260 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
