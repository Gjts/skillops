...
export function KpiStrip({ runs, successRate, lifecycleOnly, reportedOutcomeRuns, outcomeCoverage, activeSkills, cost, costReportedRuns, mode }: KpiStripProps) {
